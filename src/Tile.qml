...
Item {
    ...
    readonly property var typeColors: ["#D55E00", "#56B4E9", "#009E73"]
    readonly property var typeColorsDim: ["#7A3500", "#1A5F8A", "#005740"]

    // ── Death animation (0 = alive → 1 = fully gone)
    ...
    Rectangle {
        ...
        // 0→0.25: lerp tile color to gold, 0.25→1.0: fade out
        color: {
    ...
    // ── Gold shimmer — expanding ring blooms outward as tile goes gold then fades
    // Uses animTime not "time" — "time" is a reserved Qt 5 built-in in ShaderEffect
    ShaderEffect {
        id: shimmer
